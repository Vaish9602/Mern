...
let person2 = "Riya";
let person2Age = 21;
console.log("sum of ages both the person:", person1Age + person2Age);
//let variables can change their values
person1 = "harsh Singh"; // declaration and defination
console.log(person1);
...
// - number=234,number/10=23.4=> Math.floor
// print number% 10
...
// multiply=> expect addition,all arithmetic operators convert string to number if possible to
const num = "123"
const str = "abc"
let result;
